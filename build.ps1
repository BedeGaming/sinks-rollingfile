...
if ($env:BuildSemanticVersion -eq $null) {
    ...
    $env:BuildSemanticVersion = "rc1-" + $autoVersion
...
foreach {
    ...
    $content = $content.Replace("2.0.0-*", "2.0.0-$env:BuildSemanticVersion")
...
foreach {
    $content = get-content "$_"
    $content = $content.Replace("2.0.0-$env:BuildSemanticVersion", "2.0.0-*")
    set-content "$_" $content -encoding UTF8
}
